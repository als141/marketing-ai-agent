...
class PendingQuestionGroup:
    ...
    responses: Optional[dict[str, str]] = None  # {question_id: answer}
...
class AskUserStore:
    ...
    def get_group(self, group_id: str) -> Optional[PendingQuestionGroup]:
        return self._pending.get(group_id)
